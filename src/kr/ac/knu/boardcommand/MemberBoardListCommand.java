...
public class MemberBoardListCommand implements Command {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
		...
		if (member == null) {
			...
			ArrayList<BoardEntity> list = dao.myselect(column, keyword, startNum, scope, member.getId());
			...
			action.setPath("WEB-INF/myboardList.jsp"); // jsp
