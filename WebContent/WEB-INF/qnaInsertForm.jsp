...
<div class = "container">
	...
	<tbody>
		...
		<tr> 	
			<th width = "150">QNA 비밀번호</th>
			<td><input type="password" name="qna_pas" placeholder="숫자,영문,특수문자 조합의 최대 6글자"  onblur="test(this.value)" maxlength="6"class="form-control"/></td>
		</tr>
		<tr>
