...
<section class="section">
		...
		<h2 align="center" id = faqbbs><font color="#FFD159">글 수정</font></h2>
			...
			<div class = "container">
				<table class="table table-bordered">
					...
					<tr>	
						...
						<td>
						<%= faq.getFaq_number()%>
						<input type="hidden" name="faq_number" value="<%= faq.getFaq_number() %>" class="form-control"/>
						</td>
					</tr>
					<tr>
						<th>Type</th>
					...
					<tr>
						<th>Title</th>
						<td><input type = "text" name = "faq_title" value = "<%= faq.getFaq_title() %>" class="form-control" /></td>
					</tr>
					<tr>
				      <td colspan = "2" ><textarea name="faq_content" cols="250" rows="22" placeholder="내용을 입력해주세요." class="form-control"><%= faq.getFaq_content() %></textarea></td>
				   </tr>
